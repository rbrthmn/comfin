...
enum class OperationType(
    ...
    TRANSFER(stringId = R.string.operation_type_transfer, hasOriginAccount = true, hasDestinationAccount = true),
    ...
    RESERVE_ALLOCATION(stringId = R.string.operation_type_reserve_allocation, hasReserve = true, hasOriginAccount = true),
    RESERVE_WITHDRAWAL(stringId = R.string.operation_type_reserve_withdrawal, hasReserve = true, hasDestinationAccount = true),
