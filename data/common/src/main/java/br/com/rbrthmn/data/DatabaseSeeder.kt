...
object DatabaseSeeder {
    ...
    private suspend fun seedTransactions(
        ...
        listOf(
            ...
            // February 2026
            TransactionEntity(date = LocalDate.of(2026, 2, 26).toEpochDay(), counterparty = "Caixinha",                  notes = "Proventos",         amount = 76.59,   type = "PIX", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 24).toEpochDay(), counterparty = "Efuti Com",                 notes = null,                amount = -25.6,   type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 21).toEpochDay(), counterparty = "RD Saúde",                  notes = "Soro",              amount = -47.8,   type = "PIX", category = "Saúde",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 19).toEpochDay(), counterparty = "Izzy",                      notes = "Bob's",             amount = -56.5,   type = "PIX", category = "Alimentação", bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 17).toEpochDay(), counterparty = "Izzy",                      notes = null,                amount = 40.0,    type = "TED", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 15).toEpochDay(), counterparty = "Supreme Eletrônicos",       notes = null,                amount = -20.0,   type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 12).toEpochDay(), counterparty = "Rodolfo",                   notes = null,                amount = -150.0,  type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2, 10).toEpochDay(), counterparty = "Petit Jornal",              notes = null,                amount = -10.0,   type = "PIX", category = "Doação",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2,  7).toEpochDay(), counterparty = "Izzy",                      notes = "Compras mercado",   amount = 25.0,    type = "PIX", category = "Alimentação", bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2,  5).toEpochDay(), counterparty = "Shopee",                    notes = "Botas boxe",        amount = -99.9,   type = "PIX", category = "Vestuário",   bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 2,  3).toEpochDay(), counterparty = "Leontina",                  notes = "Doação",            amount = -10.0,   type = "PIX", category = "Doação",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            // March 2026
            TransactionEntity(date = LocalDate.of(2026, 3, 25).toEpochDay(), counterparty = "Calma Chocolate",           notes = "Presentes",         amount = -26.0,   type = "PIX", category = "Presente",    bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3, 20).toEpochDay(), counterparty = "Vitória Carmo",             notes = "Ovo Dengo",         amount = -428.0,  type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3, 18).toEpochDay(), counterparty = "Irmãos Credo",              notes = "Ovo Dengo",         amount = 213.0,   type = "PIX", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3, 15).toEpochDay(), counterparty = "Calma Chocolate",           notes = "Presentes",         amount = -26.0,   type = "PIX", category = "Presente",    bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3, 13).toEpochDay(), counterparty = "Guilherme",                 notes = "Role domingo",      amount = -25.0,   type = "PIX", category = "Lazer",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3, 10).toEpochDay(), counterparty = "Mila",                      notes = "Ajuda cosméticos",  amount = 450.0,   type = "PIX", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3,  8).toEpochDay(), counterparty = "Petit Jornal",              notes = null,                amount = -10.0,   type = "PIX", category = "Doação",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3,  5).toEpochDay(), counterparty = "Posto Asa Norte",           notes = null,                amount = -50.0,   type = "PIX", category = "Transporte",  bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2026, 3,  2).toEpochDay(), counterparty = "Camacho",                   notes = "Festa",             amount = -30.0,   type = "PIX", category = "Lazer",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            // December 2025
            TransactionEntity(date = LocalDate.of(2025, 12, 28).toEpochDay(), counterparty = "Vitória Carmo",            notes = "Bolão",             amount = -6.0,    type = "PIX", category = "Lazer",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 26).toEpochDay(), counterparty = "Mila Damasceno",           notes = null,                amount = -8.0,    type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 22).toEpochDay(), counterparty = "Arthur",                   notes = "Flor",              amount = -135.0,  type = "PIX", category = "Presente",    bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 20).toEpochDay(), counterparty = "Silas Etelvino",           notes = null,                amount = -5.0,    type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 18).toEpochDay(), counterparty = "Luiz Carlos",              notes = "Bolão",             amount = -18.0,   type = "PIX", category = "Lazer",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 15).toEpochDay(), counterparty = "UFG",                      notes = "Décimo terceiro",   amount = 3036.0,  type = "TED", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 13).toEpochDay(), counterparty = "Loteria Caixa",            notes = null,                amount = -12.0,   type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12, 11).toEpochDay(), counterparty = "Hellen",                   notes = "Confra",            amount = -10.0,   type = "PIX", category = "Lazer",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12,  9).toEpochDay(), counterparty = "Wellington",               notes = null,                amount = -205.0,  type = "PIX", category = "Outros",      bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12,  6).toEpochDay(), counterparty = "Isabela",                  notes = "Terapia",           amount = -600.0,  type = "PIX", category = "Saúde",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12,  4).toEpochDay(), counterparty = "Mila",                     notes = null,                amount = 700.0,   type = "PIX", category = "Renda",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
            TransactionEntity(date = LocalDate.of(2025, 12,  2).toEpochDay(), counterparty = "Gleice Lopes",             notes = "Limpeza dental",    amount = -300.0,  type = "PIX", category = "Saúde",       bankAccountId = nubankId, creditCardId = null, reserveId = null),
        ).forEach { dao.insert(it) }
    }
}
